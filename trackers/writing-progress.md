...
|---|---|---|---|---|
| Paper pool: 20 locked (5/journal) | — | not started | pods | `trackers/papers-pool.md` |
| Extraction notes ×20 | — | not started | pods | `sources/` |
| Abstract | 2% | not started | Member 8 | write LAST |
| Introduction | 3% | not started | Member 7 | context + scope + organization (no formal RQs) |
| Literature Review | **10%** | not started | Members 2, 3, 4, 5 | thematic: §3.3–3.7 per `paper/outline.md` |
| Tables and Figures | 3% | not started | Member 6 | Table 1 first — it drives everything |
| Conclusion | 2% | not started | Member 7 | answer the RQs |
| Formatting (AIR style) | 2% | not started | Member 8 | Springer Basic (numeric, brackets) |
| References | 3% | not started | Member 8 | every `[n]` resolves both ways |
